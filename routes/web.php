...
Route::get('/checkout/{package}', [CheckoutController::class, 'showRegister'])->name('package.checkout');
Route::post('/checkout', [CheckoutController::class, 'processCheckout'])->name('package.process');
